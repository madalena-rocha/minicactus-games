...
function onScroll() {
  // o objetivo da função é gerencial os scrolls da página
  showNavOnScroll();
...
function showNavOnScroll() {
  // o objetivo da função é mostrar o navigation ao fazer o scroll
  if (scrollY > 0) {
...
function showBackToTopButtonOnScroll() {
  // o objetivo da função é mostrar o BackToTopButton ao fazer o scroll
  if (scrollY > 550) {
...
function openMenu() {
  // a função será executada quando clicar nos botões de abrir e fechar o menu
...
ScrollReveal({
  // quando iniciar o scroll, os elementos serão revelados de cima para baixo vagarosamente
  origin: "top",
  distance: "30px",
  duration: 700,
}).reveal(` 
